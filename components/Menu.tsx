...
const Menu = () => {
  return (
    <div className="flex flex-col justify-center items-center overflow-hidden lg:justify-start lg:h-[70rem]">
      <div className="relative font-sans text-center leading-[1.7rem] text-[2rem] text-white my-[3rem] md:text-[5rem] lg:h-[18rem] md:leading-[4rem] lg:flex lg:flex-col lg:justify-center lg:font-bold">
        <div className="absolute w-[43rem] h-[33rem] right-[-2rem] top-[-3rem] md:right-[13rem] lg:w-[75rem] lg:h-[57rem] lg:right-[22rem] lg:top-[9rem] animate-spin-slow blur-[31px]">
          <Image
            alt=""
        ...
        <div className="absolute hidden lg:block lg:w-[32rem] lg:h-[22rem] lg:right-[-44rem] lg:top-[-2rem] animate-spin-slow blur-[31px]">
          <Image
            alt=""
            src="/gradient-designs/shape-1.svg"
            fill
      ...
      <section className="p-[1rem] lg:grid lg:grid-cols-2 lg:justify-center lg:items-center lg:gap-4 z-10">
        <Link
          href="#projects"
          className=" bg-gradient-to-r from-purple-400 via-blue-400 to-yellow-400
    background-animate h-[17rem] w-full rounded-[3rem] flex flex-col justify-between items-center p-[2rem] md::max-w-[30rem] lg:max-w-full lg:h-[30rem]"
        >
        ...
        <div className="flex w-full gap-[1rem] pt-4 lg:h-full lg:pt-0 lg:flex lg:flex-col">
          <Link
            href="#tech"
            className="relative  rounded-full w-full p-[.5rem] flex flex-col justify-center items-center gap-[.5rem] h-[9rem] lg:col-span-2 lg:h-full"
          >
          ...
          <Link
            href="#contact"
            className="relative  text-white rounded-full w-full p-[.5rem] flex flex-col justify-center items-center gap-[.5rem] h-[9rem] lg:row-span-2 col-span-2 lg:h-full"
          >
            <div className="absolute w-full h-full ">
              <Image
                alt=""
